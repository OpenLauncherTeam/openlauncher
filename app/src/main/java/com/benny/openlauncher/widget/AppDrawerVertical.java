...
public class AppDrawerVertical extends CardView {
    ...
    public void preInit() {
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                layoutManager = new GridLayoutManager(getContext(), AppSettings.get().getDrawerColumnCount());
    ...
    private void setPortraitValue() {
        layoutManager.setSpanCount(AppSettings.get().getDrawerColumnCount());
        gridDrawerAdapter.notifyAdapterDataSetChanged();
    }

    private void setLandscapeValue() {
        layoutManager.setSpanCount(AppSettings.get().getDrawerRowCount());
        gridDrawerAdapter.notifyAdapterDataSetChanged();
    }
