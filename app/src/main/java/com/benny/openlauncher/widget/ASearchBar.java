...
public class ASearchBar extends FrameLayout {
    ...
    public ASearchBar(@NonNull Context context) {
        super(context);
        init();
    }

    public ASearchBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ASearchBar(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
